    ...
    <div className="space-y-7">
      ...
      <Card className="p-4 sm:p-5">
        ...
        <form
          ...
          <button
            type="submit"
            className="mt-auto h-11 rounded-xl bg-primary px-5 text-sm font-semibold text-white transition hover:bg-primary-strong">
            اعمال فیلتر
          </button>
        </form>
      </Card>
        ...
        items={[
          {
            ...
            label: "همه",
            href: "/explore",
            count: content.prompts.length + content.skills.length,
          },
          {
            key: "prompts",
            label: "پرامپت‌ها",
      ...
      {(activeType === "all" || activeType === "prompts") &&
      content.prompts.length ? (
        <section aria-labelledby="explore-prompts">
          <h2 id="explore-prompts" className="mb-4 text-lg font-bold">
            پرامپت‌ها
          </h2>
            ...
            {content.prompts.map((prompt) => (
              <PromptCard
                ...
                stats={{
                  ...
                  rating: prompt.stats.ratingAverage,
                }}
              />
            ))}
          </div>
      ...
      {(activeType === "all" || activeType === "skills") &&
      content.skills.length ? (
        <section aria-labelledby="explore-skills">
          <h2 id="explore-skills" className="mb-4 text-lg font-bold">
            مهارت‌ها
          </h2>
          <div className="grid gap-4 md:grid-cols-2 2xl:grid-cols-3">
