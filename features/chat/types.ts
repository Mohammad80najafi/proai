...
export type ChatMessage = { id: string; conversationId: string; content: string; image: ChatImageAttachment | null; createdAt: string; sender: ChatUser | null; own: boolean; clientNonce: string | null };
